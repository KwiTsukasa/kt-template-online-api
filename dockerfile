...
COPY dist ./dist
COPY sql/bot-adapter-protocol-v1.sql sql/bot-adapter-menu-v1.sql sql/bot-adapter-protocol-v1-verify.sql sql/media-governance-series-work-v1.sql sql/media-governance-series-work-v1-verify.sql sql/media-governance-rss-context-v2.sql sql/media-governance-rss-context-v2-verify.sql ./sql/
