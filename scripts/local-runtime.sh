...
export_local_profile() {
  ...
  export QQBOT_PLUGIN_QUEUE_REDIS_HOST=$redis_host
  export QQBOT_PLUGIN_QUEUE_REDIS_PORT=$redis_port
  export QQBOT_PLUGIN_TASK_QUEUE_REDIS_HOST=$redis_host
  export QQBOT_PLUGIN_TASK_QUEUE_REDIS_PORT=$redis_port
  export QQBOT_ENABLED=false
  export QQBOT_EVENT_BUS=local
  export MQTT_URL=
  export QQBOT_NAPCAT_WATCHDOG_ENABLED=false
