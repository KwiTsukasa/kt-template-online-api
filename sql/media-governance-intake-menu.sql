...
VALUES
  ...
  (2041700000000100603, 2041700000000100600, 'MediaGovernanceAgentSession', '/media/governance/tasks/:taskId/agent', '/media/governance/agent-session/index', NULL, 'Media:Governance:AgentOperate', 'menu', '{"activePath":"/media/governance/tasks","hideInMenu":true,"title":"CodexAgent 治理会话"}', 1, 2),
