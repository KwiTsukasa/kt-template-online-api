...
VALUES
  ...
  (2041700000000100206, 2041700000000100002, 'SystemNotice', '/system/notice', '/system/notice/list', NULL, 'System:Notice:List', 'menu', '{"hideInMenu":true,"icon":"mdi:bell-outline","title":"system.notice.title"}', 1, 7),
