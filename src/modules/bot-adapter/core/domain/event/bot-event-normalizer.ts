...
): payload is BotOneBotEvent & { message_type: string } {
  return (
 ...
 */
export function buildDedupeKey(message: BotNormalizedMessage) {
  return [
    message.selfId,
    message.messageType,
    message.targetId,
 ...
 */
export function getOneBotOfflineReason(payload: BotOneBotEvent) {
 ...
 */
function extractMessageText(payload: BotOneBotEvent) {
 ...
 */
function normalizeMessageType(messageType?: string): BotMessageType | null {
