...
@Entity('bot_account')
@Index('uk_bot_account_official_app_id', ['officialAppId'], { unique: true })
export class BotAccount {
  ...
  connectStatus: BotConnectionStatus;

  @Column({ default: 'offline', length: 32, name: 'onebot_status' })
  oneBotStatus: BotConnectionStatus;
  ...
  clientRole: null | BotConnectionRole;
