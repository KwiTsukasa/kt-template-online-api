...
} from './bot-message-subscriber.dto';
...
const allowlistTargetOptions = (
  value: BotMessagePushTargetOptionsResponse,
): BotMessagePushTargetOptionsResponse => ({
...
@Controller('message-management/subscribers/bot/accounts/:selfId')
...
export class BotAccountMessagePushController {
  constructor(
    private readonly bindingService: BotAccountMessagePushService,
    private readonly targetOptionsService: BotMessageTargetOptionsService,
  ) {}
