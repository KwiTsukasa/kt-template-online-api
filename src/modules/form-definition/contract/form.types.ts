...
export type FormDefinition = {
  ...
  uiSchema: {
    columns: 1 | 2 | 3;
    fields: { key: string; component: FormControl; span: number; placeholder: string; help: string }[];
  };
};
...
export interface FormDefinitionPort {
  ...
  validate: (reference: PublishedReference, input: unknown, writableFields?: readonly string[]) => Promise<Record<string, DataScalar>>;
}
