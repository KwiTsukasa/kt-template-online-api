...
import { MESSAGE_MANAGEMENT_PERMISSION } from './message-management-permission.decorator';

@Injectable()
export class MessageManagementPermissionGuard implements CanActivate {
