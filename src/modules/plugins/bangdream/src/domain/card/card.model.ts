...
import { BANGDREAM_CARD_TYPE_NAME } from '@/modules/plugins/bangdream/src/config/dictionary/default-dictionary';
import { cardResourceRepository } from '@/modules/plugins/bangdream/src/domain/card/card-resource.repository';
