...
import {
  getPresentGachaList,
  Gacha,
} from '@/modules/plugins/bangdream/src/domain/gacha/gacha.model';
...
import { drawDegreeListOfEvent } from '@/modules/plugins/bangdream/src/domain/catalog/degree-list.renderer';
import {
  Song,
  getPresentSongList,
...
import { isBirthdayGachaType } from '@/modules/plugins/bangdream/src/domain/policy/gacha.policy';
import {
  drawSongInList,
  drawSongListInList,
} from '@/modules/plugins/bangdream/src/domain/song/song-list.renderer';
