...
import { BANGDREAM_EVENT_STAGE_NAME } from '@/modules/plugins/bangdream/src/config/dictionary/default-dictionary';
import { BANGDREAM_EVENT_STAGE_STROKE_COLOR } from '@/modules/plugins/bangdream/src/config/runtime-options';
import {
...
} from '@/modules/plugins/bangdream/src/domain/event/event-stage-data.repository';
