...
import { starList } from '@/modules/plugins/bangdream/src/domain/card/card-rarity.renderer';
...
import { deckRankResourceRepository } from '@/modules/plugins/bangdream/src/domain/player/deck-rank.repository';
import {
...
} from '@/modules/plugins/bangdream/src/domain/player/player-band-detail.layout';
