...
import {
  ...
  addStat,
  Stat,
} from '@/modules/plugins/bangdream/src/domain/card/card.model';
import { AreaItem } from '@/modules/plugins/bangdream/src/domain/catalog/area-item.model';
import { Event } from '@/modules/plugins/bangdream/src/domain/event/event.model';
import { difficultyNameList } from '@/modules/plugins/bangdream/src/domain/song/song.model';
import {
  playerDataRepository,
  type PlayerDataRepository,
  type PlayerDetailMode,
} from '@/modules/plugins/bangdream/src/domain/player/player-data.repository';
