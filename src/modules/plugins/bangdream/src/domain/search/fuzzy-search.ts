...
} from '@/modules/plugins/bangdream/src/domain/search/fuzzy-search-rules';
import { searchDictionaryRepository } from '@/modules/plugins/bangdream/src/domain/search/search-dictionary.repository';
import type {
  FuzzySearchConfig,
  FuzzySearchMatchValue,
  FuzzySearchResult,
  FuzzySearchResultWriter,
} from '@/modules/plugins/bangdream/src/domain/search/fuzzy-search.types';
...
export { checkRelationList } from '@/modules/plugins/bangdream/src/domain/search/relation-matcher';
