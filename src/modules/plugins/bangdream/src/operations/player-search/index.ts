import { drawPlayerDetail } from '@/modules/plugins/bangdream/src/domain/player/player-detail.renderer';
import { BANGDREAM_PLAYER_CATALOG_KEYS } from '@/modules/plugins/bangdream/src/operations/catalog-keys';
