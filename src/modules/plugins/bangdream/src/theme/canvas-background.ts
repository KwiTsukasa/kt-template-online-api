import { createBlurredTrianglePattern } from '@/modules/plugins/bangdream/src/theme/canvas-background-triangle';
import { scatterImages } from '@/modules/plugins/bangdream/src/theme/canvas-background-scatter';
import { drawTextOnCanvas } from '@/modules/plugins/bangdream/src/theme/canvas-background-text';
import {
  loadImage,
  Image,
  Canvas,
