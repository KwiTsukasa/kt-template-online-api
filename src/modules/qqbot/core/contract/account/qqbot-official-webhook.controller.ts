...
@ApiTags('QQBot - 官方 Webhook')
@Controller('qqbot/official')
export class QqbotOfficialWebhookController {
  constructor(private readonly officialService: QqbotOfficialService) {}
