...
@Index('idx_qqbot_message_delivery_history', [
  'subscriptionId',
  'messageEventId',
])
export class QqbotMessageDelivery {
  ...
  @Column({ length: 32 }) status: QqbotMessageDeliveryStatus;
