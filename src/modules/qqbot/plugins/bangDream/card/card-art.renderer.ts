import { setFontStyle } from '@/modules/qqbot/plugins/bangDream/theme/canvas-text';
import { Band } from '@/modules/qqbot/plugins/bangDream/catalog/band.model';
import { Attribute } from '@/modules/qqbot/plugins/bangDream/catalog/attribute.model';
import { Card } from '@/modules/qqbot/plugins/bangDream/card/card.model';
import { Image, Canvas, loadImage } from 'skia-canvas';
import { drawCardIconSkill } from '@/modules/qqbot/plugins/bangDream/card/card-skill-text.renderer';
