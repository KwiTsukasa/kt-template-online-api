...
import { drawCardIllustration } from '@/modules/qqbot/plugins/bangDream/card/card-art.renderer';
import { drawSkillInList } from '@/modules/qqbot/plugins/bangDream/card/card-skill-list.renderer';
import { drawTimeInList } from '@/modules/qqbot/plugins/bangDream/event/event-time.renderer';
import { drawCardPrefixInList } from '@/modules/qqbot/plugins/bangDream/card/card-prefix.renderer';
import { drawCardStatInList } from '@/modules/qqbot/plugins/bangDream/card/card-stat.renderer';
import { drawCardListInList } from '@/modules/qqbot/plugins/bangDream/card/card-icon.renderer';
import { drawSdCharacterInList } from '@/modules/qqbot/plugins/bangDream/card/card-sd-character.renderer';
import { drawEventDataBlock } from '@/modules/qqbot/plugins/bangDream/shared/detail-block.renderer';
