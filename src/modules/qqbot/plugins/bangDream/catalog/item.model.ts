...
import { itemResourceRepository } from '@/modules/qqbot/plugins/bangDream/catalog/item-resource.repository';
import { globalDefaultServer } from '@/modules/qqbot/plugins/bangDream/config/runtime-config';
import { BANGDREAM_ITEM_TYPE_PREFIXES } from '@/modules/qqbot/plugins/bangDream/shared/bangdream-constants';
