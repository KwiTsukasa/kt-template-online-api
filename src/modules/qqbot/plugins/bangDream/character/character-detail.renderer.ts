...
import { drawCharacterHalfBlock } from '@/modules/qqbot/plugins/bangDream/shared/detail-block.renderer';
...
import { formatMonthDay } from '@/modules/qqbot/plugins/bangDream/event/event-time.renderer';
import {
  stackImage,
  stackImageHorizontal,
} from '@/modules/qqbot/plugins/bangDream/shared/image-stack';
import { drawBandInList } from '@/modules/qqbot/plugins/bangDream/catalog/band-list.renderer';
import { config } from '@/modules/qqbot/plugins/bangDream/search/fuzzy-search';
import { getColorFromHex } from '@/modules/qqbot/plugins/bangDream/catalog/color.model';
