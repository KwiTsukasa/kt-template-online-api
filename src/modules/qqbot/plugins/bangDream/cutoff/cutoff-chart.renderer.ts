...
import { drawTimeLineChart } from '@/modules/qqbot/plugins/bangDream/cutoff/timeline-chart.renderer';
...
import { getPresetColor } from '@/modules/qqbot/plugins/bangDream/catalog/color.model';
