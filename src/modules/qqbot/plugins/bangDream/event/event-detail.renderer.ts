...
import { drawDataBlock } from '@/modules/qqbot/plugins/bangDream/shared/data-block.renderer';
import { drawGachaDataBlock } from '@/modules/qqbot/plugins/bangDream/shared/detail-block.renderer';
import { Image, Canvas } from 'skia-canvas';
import { drawBannerImageCanvas } from '@/modules/qqbot/plugins/bangDream/shared/data-block.renderer';
import { drawTimeInList } from '@/modules/qqbot/plugins/bangDream/event/event-time.renderer';
import { drawAttributeInList } from '@/modules/qqbot/plugins/bangDream/catalog/attribute-list.renderer';
import { drawCharacterInList } from '@/modules/qqbot/plugins/bangDream/character/character-list.renderer';
import { statConfig } from '@/modules/qqbot/plugins/bangDream/card/card-stat.renderer';
import { drawCardListInList } from '@/modules/qqbot/plugins/bangDream/card/card-icon.renderer';
import {
  getPresentGachaList,
  Gacha,
...
import { createOutputFinalImages } from '@/modules/qqbot/plugins/bangDream/theme/canvas-output';
import { drawDegreeListOfEvent } from '@/modules/qqbot/plugins/bangDream/catalog/degree-list.renderer';
import {
  Song,
  getPresentSongList,
...
import {
  globalDefaultServer,
  serverNameFullList,
} from '@/modules/qqbot/plugins/bangDream/config/runtime-config';
import { isBirthdayGachaType } from '@/modules/qqbot/plugins/bangDream/policy/gacha.policy';
import {
  drawSongInList,
  drawSongListInList,
} from '@/modules/qqbot/plugins/bangDream/song/song-list.renderer';
import { drawDottedLine } from '@/modules/qqbot/plugins/bangDream/theme/canvas-dotted-line';
import { createHorizontalSeparatorSpec } from '@/modules/qqbot/plugins/bangDream/theme/layout';
