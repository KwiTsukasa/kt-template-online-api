...
import {
  ...
  formatTime,
} from '@/modules/qqbot/plugins/bangDream/event/event-time.renderer';
import { drawTextWithImages } from '@/modules/qqbot/plugins/bangDream/theme/canvas-text';
import { getEventGachaAndCardList } from '@/modules/qqbot/plugins/bangDream/event/event-detail.renderer';
...
import { eventRepository } from '@/modules/qqbot/plugins/bangDream/event/event.repository';
import { createVerticalSeparatorSpec } from '@/modules/qqbot/plugins/bangDream/theme/layout';
