import {
  ...
  stageTypeName,
  Stage,
} from '@/modules/qqbot/plugins/bangDream/event/event-stage.model';
import { BangDreamEventStageType } from '@/modules/qqbot/plugins/bangDream/shared/bangdream-constants';
import {
  Song,
  difficultyColorList,
