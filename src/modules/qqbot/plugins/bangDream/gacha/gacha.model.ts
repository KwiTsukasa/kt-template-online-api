...
import { BANGDREAM_GACHA_TYPE_NAME } from '@/modules/qqbot/plugins/bangDream/shared/bangdream-constants';
import {
  isFreeGachaType,
  isPermanentJapaneseGachaPeriod,
} from '@/modules/qqbot/plugins/bangDream/policy/gacha.policy';
import { gachaResourceRepository } from '@/modules/qqbot/plugins/bangDream/gacha/gacha-resource.repository';
