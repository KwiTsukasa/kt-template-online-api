...
import { drawPlayerDetailBlockWithIllustration } from '@/modules/qqbot/plugins/bangDream/shared/detail-block.renderer';
import {
  assetsRootPath,
  serverNameFullList,
} from '@/modules/qqbot/plugins/bangDream/config/runtime-config';
import * as path from 'path';
import { drawPlayerCardInList } from '@/modules/qqbot/plugins/bangDream/player/player-card-icon.renderer';
import {
  line,
  drawList,
} from '@/modules/qqbot/plugins/bangDream/shared/list-frame.renderer';
import { drawStatInList } from '@/modules/qqbot/plugins/bangDream/card/card-stat.renderer';
...
} from '@/modules/qqbot/plugins/bangDream/player/player-band-detail.renderer';
import { drawPlayerDifficultyDetailInList } from '@/modules/qqbot/plugins/bangDream/player/player-difficulty-detail.renderer';
import { drawCharacterRankInList } from '@/modules/qqbot/plugins/bangDream/player/player-character-detail.renderer';
import { loadImageFromPath } from '@/modules/qqbot/plugins/bangDream/theme/canvas-image';
import { playerRepository } from '@/modules/qqbot/plugins/bangDream/player/player.repository';
