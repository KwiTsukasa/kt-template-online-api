...
import { searchDictionaryRepository } from '@/modules/qqbot/plugins/bangDream/search/search-dictionary.repository';
import type {
  FuzzySearchConfig,
  FuzzySearchMatchValue,
  FuzzySearchResult,
  FuzzySearchResultWriter,
} from '@/modules/qqbot/plugins/bangDream/search/fuzzy-search.types';
...
export { checkRelationList } from '@/modules/qqbot/plugins/bangDream/search/relation-matcher';
