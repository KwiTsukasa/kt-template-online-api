...
import { drawSongDataBlock } from '@/modules/qqbot/plugins/bangDream/shared/detail-block.renderer';
...
import { drawSongMetaListDataBlock } from '@/modules/qqbot/plugins/bangDream/shared/detail-block.renderer';
import {
  globalDefaultServer,
  serverNameFullList,
} from '@/modules/qqbot/plugins/bangDream/config/runtime-config';
import { formatSeconds } from '@/modules/qqbot/plugins/bangDream/event/event-time.renderer';
