...
import { songResourceRepository } from '@/modules/qqbot/plugins/bangDream/song/song-resource.repository';
import type { BestdoriNote } from '@/modules/qqbot/plugins/bangDream/song/song-chart-preview.layout';
