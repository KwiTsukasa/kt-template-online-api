import { createBlurredTrianglePattern } from '@/modules/qqbot/plugins/bangDream/theme/canvas-background-triangle';
import { scatterImages } from '@/modules/qqbot/plugins/bangDream/theme/canvas-background-scatter';
import { drawTextOnCanvas } from '@/modules/qqbot/plugins/bangDream/theme/canvas-background-text';
