...
import { BANGDREAM_GACHA_TYPE_NAME } from '@/modules/qqbot/plugins/bangdream/src/config/dictionary/default-dictionary';
import {
  isFreeGachaType,
  isPermanentJapaneseGachaPeriod,
} from '@/modules/qqbot/plugins/bangdream/src/domain/policy/gacha.policy';
import { gachaResourceRepository } from '@/modules/qqbot/plugins/bangdream/src/domain/gacha/gacha-resource.repository';
