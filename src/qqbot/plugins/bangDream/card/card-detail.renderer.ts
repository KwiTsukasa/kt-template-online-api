...
import { drawCardIllustration } from '@/qqbot/plugins/bangDream/card/card-art.renderer';
import { drawSkillInList } from '@/qqbot/plugins/bangDream/card/card-skill-list.renderer';
import { drawTimeInList } from '@/qqbot/plugins/bangDream/event/event-time.renderer';
import { drawCardPrefixInList } from '@/qqbot/plugins/bangDream/card/card-prefix.renderer';
import { drawCardStatInList } from '@/qqbot/plugins/bangDream/card/card-stat.renderer';
import { drawCardListInList } from '@/qqbot/plugins/bangDream/card/card-icon.renderer';
import { drawSdCharacterInList } from '@/qqbot/plugins/bangDream/card/card-sd-character.renderer';
import { drawEventDataBlock } from '@/qqbot/plugins/bangDream/shared/detail-block.renderer';
import { drawGachaDataBlock } from '@/qqbot/plugins/bangDream/shared/detail-block.renderer';
