...
import { BANGDREAM_CARD_TYPE_NAME } from '@/qqbot/plugins/bangDream/shared/bangdream-constants';
import { cardResourceRepository } from '@/qqbot/plugins/bangDream/card/card-resource.repository';
