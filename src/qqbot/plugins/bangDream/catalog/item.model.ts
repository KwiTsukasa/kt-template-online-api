...
import { itemResourceRepository } from '@/qqbot/plugins/bangDream/catalog/item-resource.repository';
import { globalDefaultServer } from '@/qqbot/plugins/bangDream/config/runtime-config';
import { BANGDREAM_ITEM_TYPE_PREFIXES } from '@/qqbot/plugins/bangDream/shared/bangdream-constants';
