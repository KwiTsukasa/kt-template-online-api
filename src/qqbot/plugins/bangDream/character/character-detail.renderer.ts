...
import { drawCharacterHalfBlock } from '@/qqbot/plugins/bangDream/shared/detail-block.renderer';
...
import { formatMonthDay } from '@/qqbot/plugins/bangDream/event/event-time.renderer';
import {
  stackImage,
  stackImageHorizontal,
} from '@/qqbot/plugins/bangDream/shared/image-stack';
import { drawBandInList } from '@/qqbot/plugins/bangDream/catalog/band-list.renderer';
import { config } from '@/qqbot/plugins/bangDream/search/fuzzy-search';
import { getColorFromHex } from '@/qqbot/plugins/bangDream/catalog/color.model';
