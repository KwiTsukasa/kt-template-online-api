...
import { drawTimeLineChart } from '@/qqbot/plugins/bangDream/cutoff/timeline-chart.renderer';
...
import { getPresetColor } from '@/qqbot/plugins/bangDream/catalog/color.model';
