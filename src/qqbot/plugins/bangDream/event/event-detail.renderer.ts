...
import {
  getPresentGachaList,
  Gacha,
} from '@/qqbot/plugins/bangDream/gacha/gacha.model';
...
import { drawDegreeListOfEvent } from '@/qqbot/plugins/bangDream/catalog/degree-list.renderer';
import {
  Song,
  getPresentSongList,
...
import { isBirthdayGachaType } from '@/qqbot/plugins/bangDream/policy/gacha.policy';
import {
  drawSongInList,
  drawSongListInList,
} from '@/qqbot/plugins/bangDream/song/song-list.renderer';
