...
import { drawPlayerDetailBlockWithIllustration } from '@/qqbot/plugins/bangDream/shared/detail-block.renderer';
import {
  assetsRootPath,
  serverNameFullList,
} from '@/qqbot/plugins/bangDream/config/runtime-config';
import * as path from 'path';
import { drawPlayerCardInList } from '@/qqbot/plugins/bangDream/player/player-card-icon.renderer';
import { line, drawList } from '@/qqbot/plugins/bangDream/shared/list-frame.renderer';
import { drawStatInList } from '@/qqbot/plugins/bangDream/card/card-stat.renderer';
...
} from '@/qqbot/plugins/bangDream/player/player-band-detail.renderer';
import { drawPlayerDifficultyDetailInList } from '@/qqbot/plugins/bangDream/player/player-difficulty-detail.renderer';
import { drawCharacterRankInList } from '@/qqbot/plugins/bangDream/player/player-character-detail.renderer';
import { loadImageFromPath } from '@/qqbot/plugins/bangDream/theme/canvas-image';
import { playerRepository } from '@/qqbot/plugins/bangDream/player/player.repository';
