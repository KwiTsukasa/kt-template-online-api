...
import { searchDictionaryRepository } from '@/qqbot/plugins/bangDream/search/search-dictionary.repository';
import type {
  FuzzySearchConfig,
  FuzzySearchMatchValue,
  FuzzySearchResult,
  FuzzySearchResultWriter,
} from '@/qqbot/plugins/bangDream/search/fuzzy-search.types';
...
export { checkRelationList } from '@/qqbot/plugins/bangDream/search/relation-matcher';
