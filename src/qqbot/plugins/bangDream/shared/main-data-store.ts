import { bestdoriApiPath } from '@/qqbot/plugins/bangDream/config/runtime-config';
import { bangDreamBestdoriProvider } from '@/qqbot/plugins/bangDream/provider/bestdori.provider';
import { bangDreamStaticPatchProvider } from '@/qqbot/plugins/bangDream/provider/static-patch.provider';
