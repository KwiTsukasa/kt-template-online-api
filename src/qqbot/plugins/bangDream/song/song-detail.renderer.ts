...
import { drawSongMetaListDataBlock } from '@/qqbot/plugins/bangDream/shared/detail-block.renderer';
import {
  globalDefaultServer,
  serverNameFullList,
} from '@/qqbot/plugins/bangDream/config/runtime-config';
import { formatSeconds } from '@/qqbot/plugins/bangDream/event/event-time.renderer';
