import { createBlurredTrianglePattern } from '@/qqbot/plugins/bangDream/theme/canvas-background-triangle';
import { scatterImages } from '@/qqbot/plugins/bangDream/theme/canvas-background-scatter';
import { drawTextOnCanvas } from '@/qqbot/plugins/bangDream/theme/canvas-background-text';
