...
import { drawPlayerDetailBlockWithIllustration } from '@/qqbot/plugins/bangDream/tsugu/render-blocks/detail-blocks';
import {
  assetsRootPath,
  serverNameFullList,
} from '@/qqbot/plugins/bangDream/tsugu/runtime/config';
import * as path from 'path';
import { drawPlayerCardInList } from '@/qqbot/plugins/bangDream/tsugu/render-blocks/list-player-card-icon-list';
import { line, drawList } from '@/qqbot/plugins/bangDream/tsugu/render-blocks/list-frame';
import { drawStatInList } from '@/qqbot/plugins/bangDream/tsugu/render-blocks/list-stat';
...
} from '@/qqbot/plugins/bangDream/tsugu/render-blocks/list-band-detail';
import { drawPlayerDifficultyDetailInList } from '@/qqbot/plugins/bangDream/tsugu/render-blocks/list-difficulty-detail';
import { drawCharacterRankInList } from '@/qqbot/plugins/bangDream/tsugu/render-blocks/list-character-detail';
import { loadImageFromPath } from '@/qqbot/plugins/bangDream/tsugu/canvas/image-utils';
import { playerRepository } from '@/qqbot/plugins/bangDream/tsugu/models/player-repository';
