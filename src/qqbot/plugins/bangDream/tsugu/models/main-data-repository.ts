import mainAPI from './main-data-store';
import type { BANGDREAM_BESTDORI_API_PATHS } from './bangdream-protocol';
...
export const bangDreamMainDataRepository =
  new BangDreamMainDataRepository();
