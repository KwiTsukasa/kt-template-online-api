...
import { drawSongMetaListDataBlock } from '@/qqbot/plugins/bangDream/tsugu/layout/detail-blocks';
import {
  globalDefaultServer,
  serverNameFullList,
} from '@/qqbot/plugins/bangDream/tsugu/runtime/tsugu-config';
import { formatSeconds } from '@/qqbot/plugins/bangDream/tsugu/layout/list/time';
