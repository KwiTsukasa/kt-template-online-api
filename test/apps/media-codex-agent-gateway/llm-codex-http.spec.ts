...
import { LlmCodexChatController } from '../../../src/apps/media-codex-agent-gateway/presentation/llm-codex-chat.controller';
import { LlmCodexInternalGuard } from '../../../src/apps/media-codex-agent-gateway/presentation/llm-codex-internal.guard';
...
describe('LlmCodexChatController', () => {
  ...
  it('rejects the media secret boundary when the LLM secret is missing', async () => {
