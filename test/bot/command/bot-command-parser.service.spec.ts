...
import type { BotCommand } from '@/modules/bot-adapter/core/infrastructure/persistence/command/bot-command.entity';
import { BotCommandParserService } from '@/modules/bot-adapter/core/application/command/bot-command-parser.service';

describe('BotCommandParserService', () => {
  const command = {
    aliases: '["logs"]',
  ...
  const service = new BotCommandParserService();
