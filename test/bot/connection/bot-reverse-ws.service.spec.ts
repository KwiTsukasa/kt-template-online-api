jest.mock('@/modules/bot-adapter/core/application/event/bot-event.service', () => ({
  BotEventService: class {},
}));
  ...
  const service = new BotReverseWsService(
    {
      get: jest.fn((key: string) => {
        ...
        if (key === 'BOT_API_TIMEOUT_MS') return '10';
        return '';
      }),
    } as any,
    {} as any,
