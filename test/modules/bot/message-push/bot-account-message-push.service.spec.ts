...
const createFixture = (input?: {
  ...
  const manager = {
    getRepository: jest.fn((entity: unknown) => {
      if (entity === BotMessagePublishBinding) return bindingStore;
      if (entity === BotMessagePublishTarget) return targetStore;
      if (entity === BotMessageDelivery) return deliveryStore;
  ...
  const service = new BotAccountMessagePushService(
...
describe('BotAccountMessagePushService', () => {
