import { readBilibiliCardRuntimeConfig } from '../../../../src/modules/plugins/bilibili-card/src/config/bilibili-card-config';
import type { BilibiliCardPluginHost } from '../../../../src/modules/plugins/bilibili-card/src/domain/bilibili-card.types';
import { formatBilibiliVideoReply } from '../../../../src/modules/plugins/bilibili-card/src/domain/bilibili-reply-formatter';
import { createBilibiliCardGenericHostAdapter } from '../../../../src/modules/plugins/bilibili-card/src/infrastructure/integration/bilibili-card-host';
import { BilibiliVideoClient } from '../../../../src/modules/plugins/bilibili-card/src/infrastructure/integration/bilibili-video-client';
  ...
  it('clamps runtime config values from the plugin host', () => {
    const host = createHost({
      getConfig: (<T = string>(key: string) => {
        return {
          PLUGIN_BILIBILI_CARD_DEDUPE_TTL_MS: '9999999',
          PLUGIN_BILIBILI_CARD_DESC_MAX_LENGTH: '-1',
          PLUGIN_BILIBILI_CARD_HTTP_TIMEOUT_MS: '10',
          PLUGIN_BILIBILI_CARD_MAX_REDIRECTS: '99',
        }[key] as T | undefined;
