...
} from '../../../../src/modules/qqbot/message-management-adapter/qqbot-message-delivery-runner.service';
import {
...
const deliveryRow = (overrides: Partial<QqbotMessageDelivery> = {}) =>
...
const bindingRow = (overrides: Partial<QqbotMessagePublishBinding> = {}) =>
  Object.assign(new QqbotMessagePublishBinding(), {
    accountId: 'account-1',
...
const targetRow = (overrides: Partial<QqbotMessagePublishTarget> = {}) =>
  Object.assign(new QqbotMessagePublishTarget(), {
    bindingId: 'binding-1',
    enabled: true,
    id: 'target-1',
    isDeleted: false,
...
const accountRow = (overrides: Partial<QqbotAccount> = {}) =>
  Object.assign(new QqbotAccount(), {
    enabled: true,
    id: 'account-1',
    isDeleted: false,
    selfId: 'bot-1',
...
const createFixture = (input?: {
  account?: QqbotAccount | null;
  binding?: QqbotMessagePublishBinding | null;
  delivery?: QqbotMessageDelivery;
  target?: null | QqbotMessagePublishTarget;
}) => {
