...
jest.mock(
  '@/modules/plugins/bangdream/src/domain/search/fuzzy-search',
  () => ({
    fuzzySearch: mockFuzzySearch,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/song/song.model',
  () => ({
    Song: mockSongCtor,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/song/song-detail.renderer',
  () => ({
    drawSongDetail: mockDrawSongDetail,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/song/song-search.renderer',
  () => ({
    drawSongList: mockDrawSongList,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/song/song-chart.renderer',
  () => ({
    drawSongChart: mockDrawSongChart,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/song/song-random.renderer',
  () => ({
    drawSongRandom: mockDrawSongRandom,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/song/song-meta.renderer',
  () => ({
    drawSongMetaList: mockDrawSongMetaList,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/card/card-detail.renderer',
  () => ({
    drawCardDetail: mockDrawCardDetail,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/card/card-search.renderer',
  () => ({
    drawCardList: mockDrawCardList,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/card/card.model',
  () => ({
    Card: mockCardCtor,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/character/character-detail.renderer',
  () => ({
    drawCharacterDetail: mockDrawCharacterDetail,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/character/character-search.renderer',
  () => ({
    drawCharacterList: mockDrawCharacterList,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/event/event.model',
  () => ({
    getPresentEvent: mockGetPresentEvent,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/event/event-detail.renderer',
  () => ({
    drawEventDetail: mockDrawEventDetail,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/event/event-search.renderer',
  () => ({
    drawEventList: mockDrawEventList,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/event/event-stage.renderer',
  () => ({
    drawEventStage: mockDrawEventStage,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/player/player-detail.renderer',
  () => ({
    drawPlayerDetail: mockDrawPlayerDetail,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/gacha/gacha-detail.renderer',
  () => ({
    drawGachaDetail: mockDrawGachaDetail,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/gacha/gacha-simulate.renderer',
  () => ({
    drawRandomGacha: mockDrawRandomGacha,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/gacha/gacha.model',
  () => ({
    Gacha: mockGachaCtor,
...
jest.mock(
  '@/modules/plugins/bangdream/src/domain/policy/gacha.policy',
  () => ({
...
jest.mock(
  '@/modules/plugins/bangdream/src/domain/cutoff/cutoff-detail.renderer',
  () => ({
    drawCutoffDetail: mockDrawCutoffDetail,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/cutoff/cutoff-event-top.renderer',
  () => ({
    drawCutoffEventTop: mockDrawCutoffEventTop,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/cutoff/cutoff-all.renderer',
  () => ({
    drawCutoffAll: mockDrawCutoffAll,
  }),
);
jest.mock(
  '@/modules/plugins/bangdream/src/domain/cutoff/cutoff-recent.renderer',
  () => ({
...
const manifestOperations: ManifestOperation[] = JSON.parse(
  readFileSync(
    join(process.cwd(), 'src/modules/plugins/bangdream/plugin.json'),
    'utf8',
  ),
).operations;
...
describe('BangDream operation branch matrix', () => {
  beforeAll(async () => {
    const { getBangDreamOperationsByHandlerName } =
      await import('@/modules/plugins/bangdream/src/operations');
