...
jest.mock(
  '@/modules/plugins/bangdream/src/application/catalog/bangdream-catalog-cache',
  () => ({
    __esModule: true,
    default: {},
...
jest.mock(
  '@/modules/plugins/bangdream/src/application/bangdream-command-context',
  () => ({
...
jest.mock(
  '@/modules/plugins/bangdream/src/infrastructure/integration/runtime-io',
  () => ({
...
jest.mock(
  '@/modules/plugins/bangdream/src/application/render-assets',
  () => ({
    preloadBangDreamRenderAssets: mockPreloadBangDreamRenderAssets,
  }),
);

jest.mock('@/modules/plugins/bangdream/src/operations', () => ({
...
import { createPlugin } from '@/modules/plugins/bangdream/src';
import { BangDreamCommandContext } from '@/modules/plugins/bangdream/src/application/bangdream-command-context';
import { waitForBangDreamCatalogReady } from '@/modules/plugins/bangdream/src/application/catalog/bangdream-catalog-cache';
import {
  fuzzySearchPath,
  projectRoot,
} from '@/modules/plugins/bangdream/src/config/runtime-config';
import type { BangDreamRuntimeIo } from '@/modules/plugins/bangdream/src/infrastructure/integration/runtime-io';
