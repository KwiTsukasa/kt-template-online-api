import { BangDreamCardType } from '@/modules/plugins/bangdream/src/domain/common/bangdream-protocol';
import {
...
} from '@/modules/plugins/bangdream/src/domain/card/card-icon.layout';
