...
} from '@/qqbot/plugins/bangDream/tsugu/runtime/dictionary-loader';
import { BANGDREAM_DICTIONARY_CODES } from '@/qqbot/plugins/bangDream/tsugu/runtime/default-dictionary';
import {
  normalizeBangDreamBoolean,
  splitBangDreamOptionList,
} from '@/qqbot/plugins/bangDream/tsugu/runtime/runtime-options';
import { BangDreamDifficultyId } from '@/qqbot/plugins/bangDream/tsugu/models/bangdream-protocol';
