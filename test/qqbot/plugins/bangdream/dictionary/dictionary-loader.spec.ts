...
import { BANGDREAM_DICTIONARY_CODES } from '@/modules/qqbot/plugins/bangdream/src/config/dictionary/default-dictionary';
import {
  normalizeBangDreamBoolean,
  splitBangDreamOptionList,
} from '@/modules/qqbot/plugins/bangdream/src/config/runtime-options';
import { BangDreamDifficultyId } from '@/modules/qqbot/plugins/bangdream/src/domain/common/bangdream-protocol';
